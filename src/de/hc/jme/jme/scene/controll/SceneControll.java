...
//        TargetData.add(1, new TargetData(TargetData.TargetType.PYRAMID_NORMAL, 4, new Vector3f(-1495, 0, -1405)));        
        TargetData.add(1, new TargetData(TargetData.TargetType.PYRAMID_NORMAL, 3, new Vector3f(0, 0, 0)));        
    }
